function HeaderCard() {
  return (
    <>
      <div className="flex flex-col justify-center h-auto xl:h-[472px] md:bg-[url('/img/background.png')] bg-[url('/img/background-phone.png')] bg-cover bg-right-bottom rounded-[30px] md:my-4 px-[25px] py-[40px] gap-4 md:p-[80px] text-white">
